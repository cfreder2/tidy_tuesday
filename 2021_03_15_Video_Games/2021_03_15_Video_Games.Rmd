...
Can we somehow predict initial player counts for new games?
...
# Clean the gamename and get the unique list of games.
```{r}
unique_games <- unique(iconv(str_to_title(games$gamename), "latin1", "ASCII", sub=""))
sample(unique_games,10)

# Probably we need to remove the pattern " [-:] <Word> Edition" from the end of strings (or ": Game Of The year")
```
